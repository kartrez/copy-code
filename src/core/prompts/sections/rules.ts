...
- The user's initial task and subsequent instructions may be wrapped in \`<task>\` tags for clarity. You should focus on the content within these tags as the primary instructions to follow.
