...
const AUTOCOMPLETE_SERVICE_KEYBINDING_COMMAND_IDS = ["copy-coder.autocomplete.generateSuggestions"]
					...
					{!kiloCodeWrapperProperties?.kiloCodeWrapped && (
						<SearchableSetting
							...
							label={t("kilocode:autocomplete.settings.enableSmartInlineTaskKeybinding.label", {
								keybinding: keybindings["copy-coder.autocomplete.generateSuggestions"],
							})}
							className="flex flex-col gap-1">
							<VSCodeCheckbox
							...
							<div className="text-vscode-descriptionForeground text-sm mt-1">
								<Trans
									...
									values={{ keybinding: keybindings["copy-coder.autocomplete.generateSuggestions"] }}
									components={{
										DocsLink: (
											<a
												href="#"
												onClick={() =>
													openGlobalKeybindings("copy-coder.autocomplete.generateSuggestions")
												}
