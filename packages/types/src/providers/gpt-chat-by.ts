...
export const gptChatByModels = {
	...
	"coder-flash": {
		...
		description: `Qwen Coder Flash - Fast coding model with 1M context window optimized for speed.`,
	},
	"gemini-3-flash": {
		maxTokens: 65_000,
		contextWindow: 1_000_000,
	...
	"anthropic/claude-opus-4.6": {
		...
		supportsPromptCache: true,
		supportsNativeTools: false,
		inputPrice: 25 * GTP_CHAT_BY_TAKE_PROFIT_USD,
		outputPrice: 37.5 * GTP_CHAT_BY_TAKE_PROFIT_USD,
