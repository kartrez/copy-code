...
class PlusButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-code.plusButtonClicked"
...
class PromptsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-code.promptsButtonClicked"
...
class MCPButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-code.mcpButtonClicked"
...
class HistoryButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-code.historyButtonClicked"
...
class ProfileButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-code.profileButtonClicked"
...
class SettingsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-code.settingsButtonClicked"
...
class MarketplaceButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-code.marketplaceButtonClicked"
