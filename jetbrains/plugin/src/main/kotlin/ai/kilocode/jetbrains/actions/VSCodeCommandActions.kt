...
class PlusButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-coder.plusButtonClicked"
...
class PromptsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-coder.promptsButtonClicked"
...
class MCPButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-coder.mcpButtonClicked"
...
class HistoryButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-coder.historyButtonClicked"
...
class ProfileButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-coder.profileButtonClicked"
...
class SettingsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-coder.settingsButtonClicked"
...
class MarketplaceButtonClickAction : AnAction() {
    ...
    private val commandId: String = "copy-coder.marketplaceButtonClicked"
