    ...
    private class RooToolWindowContent(
        ...
        private fun createSystemInfoText(): String {
            ...
            return buildString {
                ...
                append("<h3>Copy Coder Initialization</h3>")
                ...
                if (!jcefSupported) {
                    ...
                    append("<a href='https://gpt-chat.by/docs/jetbrains-troubleshooting' target='_blank' style='color: #721c24; text-decoration: underline;'>See JetBrains docs for how to enable JCEF in your IDE</a>")
                    append("</div>")
                    append("<br>")
                }
        ...
        private val knownIssuesButton = JButton("Known Issues").apply {
            ...
            addActionListener {
                ...
                BrowserUtil.browse("https://gpt-chat.by/docs")
            }
        }
