...
**网站：** [https://gpt-chat.by/](https://gpt-chat.by/)
...
2.  **登录：** 使用您的 Google 帐户在 gpt-chat.by 登录
3.  **授权 VS Code：**
    - gpt-chat.by 将提示您打开 Visual Studio Code
...
- **最新模型：** 自动访问最新的前沿编码模型
- **提供支持：** 有关定价或 token 的问题，请联系 [hi@gpt-chat.by](mailto:hi@gpt-chat.by)
